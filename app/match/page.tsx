...
export default function MatchPage() {
  ...
  const findMatch = async () => {
    ...
    try {
      ...
      if (res.data.matched) {
        console.log("Immediate match!", res.data);
    ...
    <main className="min-h-screen bg-[#090611] px-4 py-8 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mx-auto mt-12 max-w-2xl">
          <div className="rounded-3xl border border-purple-400/30 bg-purple-500/10 p-8 text-center shadow-lg shadow-purple-900/20">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-400">
              We'll connect you with another available
              student. Your identity remains private
              until you both decide to reveal yourselves.
            </p>
            ...
            <div
              className={`mx-auto mt-5 max-w-xl rounded-2xl border p-4 text-center ${
                message.includes("Looking for")
                  ...
                  : message.includes("Connection found")
        ...
        <div className="mx-auto mt-14 grid max-w-5xl gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5 text-center">
            ...
            <p className="mt-1 text-xs leading-5 text-slate-500">
              Get matched with another available
              student from your campus.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5 text-center">
            ...
            <p className="mt-1 text-xs leading-5 text-slate-500">
              No profiles or complicated preferences.
              Just start a genuine conversation.
            </p>
          </div>
